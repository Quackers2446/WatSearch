...
import { BookOpen, Calendar, User, MapPin, Clock, FileText, ChevronDown, ChevronRight } from 'lucide-react'
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Browser</h2>
                <p className="text-gray-600 mb-4">Browse all your courses and access detailed information</p>
                        ...
                        <div key={course.id} className="card">
                            ...
                            {expandedCourse === course.id && (
                                <div className="mt-6 pt-6 border-t border-gray-200 space-y-6">
                                    ...
                                    {/* Assessments */}
                                    <div>
                                        <h4 className="font-medium text-gray-900 mb-2">Assessments</h4>
                                                ...
                                                <div key={material.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-500 capitalize">{material.type.replace('_', ' ')}</p>
                                                        </div>
                                                    </div>
                                                    <div className="text-right">
                                                        {material.required && (
                                                            <span className="text-xs bg-uw-red text-white px-2 py-1 rounded">Required</span>
                                                        )}
                                                        {material.price && (
                                    ...
                                    {course.policies.length > 0 && (
                                        <div>
                                            <h4 className="font-medium text-gray-900 mb-2">Important Policies</h4>
                                            <div className="space-y-2">
