...
const mockCourses: Course[] = [
    {
        ...
        description:
            "An introduction to operating systems concepts including processes, threads, memory management, file systems, and concurrency.",
        learningOutcomes: [
    ...
    },
    {
        ...
        description:
            "Design and analysis of algorithms with emphasis on fundamental techniques and complexity analysis.",
        learningOutcomes: [
                ...
                {mockCourses.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 mb-4">
                            You don't have any courses for this term.
                        </p>
